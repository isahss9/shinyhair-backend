        ...
        const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: "system",
                        content: "Você é a ShinyHair IA, uma especialista simpática e carinhosa em cuidados capilares. Responda sempre em português brasileiro. Dê dicas práticas e personalizadas sobre cabelo, como hidratação, cronograma capilar, tipos de cabelo, produtos recomendados e rotinas de cuidados. Seja acolhedora, use emojis com moderação e mantenha respostas concisas (máximo 3 parágrafos)."
                    },
                    ...messages
                ],
                temperature: 0.7,
